...
const basePath = '/core-tech-1776325160624';
...
export default function Home() {
  ...
  const products = [{ n: 'Hosting', d: 'Our Hosting services provide fast, secure, and reliable infrastructure for your website or application, with scalable solutions to meet your growing needs. Our expert team ensures seamless migration, setup, and ongoing support.', i: 'https://images.pexels.com/photos/17489152/pexels-photo-17489152.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Web Dev', d: 'Our Web Dev services deliver custom, user-friendly, and responsive websites that drive engagement and conversion, built on the latest technologies and best practices. From design to deployment, we handle every aspect of your web development project.', i: 'https://images.pexels.com/photos/14553720/pexels-photo-14553720.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'App Dev', d: 'Our App Dev services create mobile and desktop applications that are intuitive, feature-rich, and tailored to your business goals, with a focus on delivering seamless user experiences and driving business results.', i: 'https://images.pexels.com/photos/20694602/pexels-photo-20694602.png?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Domain', d: 'Our Domain services provide easy and secure domain registration, transfer, and management, with expert guidance on selecting the perfect domain for your online presence and protecting your brand identity.', i: 'https://images.pexels.com/photos/4160092/pexels-photo-4160092.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Inquiries', d: 'Our Inquiries service offers personalized support and consultation for businesses exploring technology solutions, with expert advice on how to leverage our services to drive growth, improve efficiency, and achieve your goals.', i: 'https://images.pexels.com/photos/7709280/pexels-photo-7709280.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/19059657/pexels-photo-19059657.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Core Tech, we are dedicated to providing the best tech solutions in Kuching, leveraging cutting-edge technology to drive business growth and innovation. Our team of experts is committed to delivering exceptional service and support to our clients. With a focus on customer satisfaction and continuous improvement, we strive to be the go-to technology partner for businesses in the region.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">Our vision is to become the leading technology solutions provider in Kuching, empowering businesses to succeed in the digital age.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">Our mission is to deliver innovative, customer-centric technology solutions that drive business success and exceed our clients\' expectations.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">We prioritize our customers\' needs, ensuring that every interaction is personalized, responsive, and tailored to their unique requirements.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">We foster a culture of innovation, continuously seeking new and better ways to solve problems, improve processes, and stay ahead of the technology curve.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/19747894/pexels-photo-19747894.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/4955393/pexels-photo-4955393.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
